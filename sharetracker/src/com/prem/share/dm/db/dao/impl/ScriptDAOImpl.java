...
public class ScriptDAOImpl extends SqlMapClientDaoSupport implements ScriptDAO {
    ...
    public int countScriptByExample(ScriptExample example) {
        Integer count = (Integer)  getSqlMapClientTemplate().queryForObject("script.ibatorgenerated_countByExample", example);
        return count;
    }
    ...
    public int deleteScriptByExample(ScriptExample example) {
        int rows = getSqlMapClientTemplate().delete("script.ibatorgenerated_deleteByExample", example);
        return rows;
    }
    ...
    public int deleteScriptByPrimaryKey(String scriptId) {
        ...
        int rows = getSqlMapClientTemplate().delete("script.ibatorgenerated_deleteByPrimaryKey", key);
        return rows;
    }
    ...
    public void insertScript(Script record) {
        getSqlMapClientTemplate().insert("script.ibatorgenerated_insert", record);
    }
    ...
    public void insertScriptSelective(Script record) {
        getSqlMapClientTemplate().insert("script.ibatorgenerated_insertSelective", record);
    }
    ...
    public List<Script> selectScriptByExample(ScriptExample example) {
        List<Script> list = getSqlMapClientTemplate().queryForList("script.ibatorgenerated_selectByExample", example);
        return list;
    }
    ...
    public Script selectScriptByPrimaryKey(String scriptId) {
        Script key = new Script();
        key.setScriptId(scriptId);
        Script record = (Script) getSqlMapClientTemplate().queryForObject("script.ibatorgenerated_selectByPrimaryKey", key);
        return record;
    }
     ...
     * @ibatorgenerated Mon Oct 24 16:28:18 IST 2011
     */
    public int updateScriptByExampleSelective(Script record, ScriptExample example) {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
        int rows = getSqlMapClientTemplate().update("script.ibatorgenerated_updateByExampleSelective", parms);
        return rows;
    }
    ...
    public int updateScriptByExample(Script record, ScriptExample example) {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
        int rows = getSqlMapClientTemplate().update("script.ibatorgenerated_updateByExample", parms);
        return rows;
    }
    ...
    public int updateScriptByPrimaryKeySelective(Script record) {
        int rows = getSqlMapClientTemplate().update("script.ibatorgenerated_updateByPrimaryKeySelective", record);
        return rows;
    }
    ...
    public int updateScriptByPrimaryKey(Script record) {
        int rows = getSqlMapClientTemplate().update("script.ibatorgenerated_updateByPrimaryKey", record);
        return rows;
    }

    /**
     * This class was generated by Apache iBATIS ibator.
     * This class corresponds to the database table script
     *
     * @ibatorgenerated Mon Oct 24 16:28:18 IST 2011
     */
